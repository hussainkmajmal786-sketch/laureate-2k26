...
export function DisplayBoard({
  ...
  return (
    <div className="dark bg-[rgb(var(--ink))] grain relative min-h-dvh overflow-hidden text-white">
      <div className="animate-bob absolute -top-1/4 left-0 h-[70vh] w-[70vh]  bg-indigo-500/25 blur-[130px]" />
      <div className="animate-bob absolute -right-1/4 bottom-0 h-[60vh] w-[60vh]  bg-cyan-400/20 blur-[120px]" />

      <Link href="/queue"
        className="absolute top-6 right-6 z-30 flex items-center gap-2  bg-white/8 px-4 py-2 text-sm text-white/40 opacity-0 backdrop-blur-sm transition-opacity hover:bg-white/14 hover:text-white focus-visible:opacity-100 lg:hover:opacity-100" >
      ...
      <div className="relative z-10 flex min-h-dvh flex-col">
        <header className="flex items-center justify-between px-8 py-7 lg:px-14 lg:py-9">
          <div className="flex items-center gap-4 lg:gap-5">
            <span className="grid h-14 w-14 place-items-center  bg-white/12 backdrop-blur-sm lg:h-16 lg:w-16">
            ...
            <div>
              ...
              <p className="text-sm text-white/45 lg:text-base">{college}</p>
            </div>
          </div>
          ...
          <div className="text-right">
            ...
            <p className="mt-1.5 text-sm text-white/45 lg:text-base">
              {now
        ...
        <main className="flex flex-1 flex-col justify-center px-8 pb-6 lg:px-14">
          <h1 className="mb-6 flex items-center gap-4 text-[clamp(1.75rem,4vw,3.25rem)] leading-none font-bold tracking-[-0.04em] lg:mb-9">
            <span className="relative flex h-3.5 w-3.5 lg:h-4 lg:w-4">
              ...
              <span className="relative inline-flex h-full w-full  bg-emerald-400" />
            </span>
            NOW SERVING
          </h1>
            ...
            {booths.map((b, i) => {
              ...
              return (
                <motion.section
                  ...
                  className="relative overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.045] p-7 backdrop-blur-xl lg:rounded-[40px] lg:p-10" >
                  <div
                  ...
                  <div className="relative flex items-center justify-between">
                    <p className="text-[clamp(1.25rem,2.2vw,2rem)] font-bold tracking-[-0.03em] text-white/85">
                      Booth {b.id}
                    </p>
                    <span className="inline-flex items-center gap-2  bg-emerald-400/15 px-3.5 py-1.5 text-sm font-medium text-emerald-300 lg:text-base">
                    ...
                    <motion.div
                      ...
                      {b.current_name ? (
                        <>
                          ...
                          <p className="mt-3 font-mono text-[clamp(0.95rem,1.5vw,1.4rem)] tracking-wider text-white/45">
                            {b.current_reg_no}
                          </p>
                        </>
                      ) : (
                        <p className="mt-9 text-[clamp(1.5rem,3vw,2.5rem)] font-semibold text-white/35">
                      ...
                      <div className="mt-7 flex items-end justify-between lg:mt-10">
                        <div>
                          <p className="text-xs font-semibold tracking-[0.16em] text-white/40 uppercase lg:text-sm">
                            Token
                          </p>
                          <p
                    ...
                    <div className="relative mt-7 border-t border-white/10 pt-5">
                      ...
                      <ol className="mt-2.5 flex flex-wrap gap-x-6 gap-y-1.5">
                        {boothQueue.slice(0, 4).map((q, n) => (
                          <li
                            key={q.id}
                            className="flex items-baseline gap-2 text-[clamp(0.9rem,1.3vw,1.2rem)] font-medium text-white/65" >
        ...
        <footer className="border-t border-white/10 bg-black/25 backdrop-blur-md">
          <div className="flex flex-wrap items-center gap-x-10 gap-y-3 px-8 py-4 lg:px-14 lg:py-5">
            <div className="flex items-center gap-6 text-sm text-white/45 lg:text-base">
              <span>
            ...
            <div className="relative overflow-hidden border-t border-white/8 py-3.5">
              <div className="animate-ticker flex w-max gap-16 whitespace-nowrap will-change-transform">
                {[...announcements, ...announcements].map((a, i) => (
                  <span
                    key={i}
                    className="flex items-center gap-4 text-[clamp(0.9rem,1.25vw,1.15rem)] text-white/55" >
